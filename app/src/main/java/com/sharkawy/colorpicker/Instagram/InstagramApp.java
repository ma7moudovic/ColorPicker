package com.sharkawy.colorpicker.Instagram;
...
public class InstagramApp {
    ...
    private void getAccessToken(final String code) {
        ...
        mProgress.show();
//        String URL =TOKEN_URL +"client_id=" + mClientId + "&client_secret="
...
//                + "&redirect_uri=" + mCallbackUrl + "&code=" + code;
        ...
        Map<String, String> params = new HashMap<String, String>();
            ...
            params.put("redirect_uri ",mCallbackUrl);
            params.put("code",code);
            params.put("Content-Type", "application/json; charset=utf-8");

//        JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.POST,TOKEN_URL
//                , new JSONObject(params), new Response.Listener<JSONObject>() {
//
//            @Override
//            public void onResponse(JSONObject response) {
//
//                Log.d(TAG, "Access token getting");
...
//                    Toast.makeText(mCtx,jsonObject.toString(), Toast.LENGTH_LONG).show();
//
//                } catch (Exception e) {
//                    e.printStackTrace();
...
//
        new Thread() {
            ...
            public void run() {
                ...
                try {
                    ...
                    String name = jsonObj.getJSONObject("user").getString(
                            "full_name");
                    Toast.makeText(mCtx,"USER INFO "+id +" USER ", Toast.LENGTH_LONG).show();
                    mSession.storeAccessToken(mAccessToken, id, user, name);

                } catch (Exception ex) {
                    what = WHAT_ERROR;
                    ex.printStackTrace();
                    Toast.makeText(mCtx,"Error "+ex.getMessage(), Toast.LENGTH_LONG).show();
                }
    ...
    public void fetchUserName(final Handler handler) {
        ...
        String new_URL =API_URL + "/users/" + mSession.getId()
...
//                try {
//                    JSONObject data_obj = response.getJSONObject(TAG_DATA);
...
//
//                    JSONObject meta_obj = response.getJSONObject(TAG_META);
//
